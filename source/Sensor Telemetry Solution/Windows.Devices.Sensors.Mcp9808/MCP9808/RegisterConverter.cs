...
namespace Windows.Devices.Sensors
{
	...
	/// the MCP9808 registers.
	/// </summary>
	public static class RegisterConverter
	{
		/// <summary>
		/// Converts an MCP9808 2-byte register value
		/// to a float.
		/// </summary>
		/// <param name="registerValue">A 2-byte register value
		/// read from the MCP9808 to be converted.</param>
