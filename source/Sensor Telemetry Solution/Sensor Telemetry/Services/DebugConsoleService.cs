...
{
	public class DebugConsoleService : BindableBase, IBackgroundService, IDebugConsoleProvider
	{
		...
		public Task<bool> Start()
		{
			...
			try
			{
				...
				{
					await this.OnExceptionEvent(args);
		...
		protected Task OnExceptionEvent(DebugEventArgs e)
		{
			try
			{
				lock (this.Items)
