...
namespace Porrey.SensorTelemetry.Shared.Interfaces
{
	public enum ApplicationSensorReadingSource
	{
		None,
		Device,
		Cloud
	...
	/// <summary>
	/// Defines the structure for the sensor reading used within the
	/// application and between instances of the application.
	/// </summary>
	public interface IApplicationSensorReading
	{
		/// <summary>
		...
		float CriticalThreshold { get; set; }
		...
		/// Defines
		/// </summary>
		ApplicationSensorReadingSource Source { get; set; }
	}
}
